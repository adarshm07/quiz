...
<div class="col-md-12"> 
    <span id="countdown" style="font-size: 50px; " class="timer"></span>    
</div>
</div>
<script>
...
<?php
  if(@$_GET['q']== 'quiz' && @$_GET['step']== 2) 
  {
    ...
    $qu=mysqli_query($con,"SELECT time FROM quiz WHERE eid='$eid'" );
    $res=mysqli_fetch_array($qu)['time'];
    ...
    echo'<br /><button id="submit" type="submit" class="btn btn-primary"><span class="glyphicon glyphicon-lock" aria-hidden="true"></span>&nbsp;Submit</button></form><script>countdown('.$res.');</script></div>';
