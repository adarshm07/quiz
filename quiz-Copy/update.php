...
{
	if(@$_GET['fdid'] && $_SESSION['key']=='1234') 
	{
		$id=@$_GET['fdid'];
...
if(isset($_SESSION['key']))
{
	if(@$_GET['demail'] && $_SESSION['key']=='1234') 
	{
		$demail=@$_GET['demail'];
...
if(isset($_SESSION['key']))
{
	if(@$_GET['q']== 'rmquiz' && $_SESSION['key']=='1234') 
	{
		$eid=@$_GET['eid'];
...
if(isset($_SESSION['key']))
{
	if(@$_GET['q']== 'addquiz' && $_SESSION['key']=='1234') 
	{
		$name = $_POST['name'];
...
if(isset($_SESSION['key']))
{
	if(@$_GET['q']== 'addqns' && $_SESSION['key']=='1234') 
	{
		$n=@$_GET['n'];
		$eid=@$_GET['eid'];
		$ch=@$_GET['ch'];
