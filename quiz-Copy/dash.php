...
<?php 
  ...
  <tr style="color:red"><td><b>Rank</b></td><td><b>Name</b></td><td><b>Gender</b></td><td><b>Department</b></td><td><b>Score</b></td></tr>';
  $c=0;
...
<?php 
  if(@$_GET['q']==1) 
  {
    ...
    echo  '<div class="panel"><table class="table table-striped title1">
    <tr><td><b>S.N.</b></td><td><b>Name</b></td><td><b>Gender</b></td><td><b>Department</b></td><td><b>Email</b></td><td><b>Year</b></td><td></td></tr>';
    $c=1;
    while($row = mysqli_fetch_array($result)) 
    {
    	$name = $row['name'];
...
if(@$_GET['q']==4 && !(@$_GET['step']) ) 
{
  ...
  <!-- Text input-->
  <div class="form-group">
    <label class="floatLabel" for="total"></label>  
    <div class="col-md-12">
  ...
  <!-- Text input-->
  <div class="form-group">
    <label class="floatLabel" for="right"></label>  
    <div class="col-md-12">
  ...
  <!-- Text input-->
  <div class="form-group">
    <label class="floatLabel" for="wrong"></label>  
    <div class="col-md-12">
  ...
  <!-- Text input-->
  <div class="form-group">
    <label class="floatLabel" for="time"></label>  
    <div class="col-md-12">
    <input id="time" name="time" placeholder="Enter time limit for each question in minute" class="form-control input-md" min="1" type="number">
  ...
  <!-- Text input-->
  <div class="form-group">
    <label class="floatLabel" for="tag"></label>  
    <div class="col-md-12">
  ...
  <!-- Text input-->
  <div class="form-group">
    <label class="floatLabel" for="desc"></label>  
    <div class="col-md-12">
...
<div class="form-group">
  <label class="floatLabel" for="qns'.$i.' "></label>  
  <div class="col-md-12">
...
<!-- Text input-->
<div class="form-group">
  <label class="floatLabel" for="'.$i.'1"></label>  
  <div class="col-md-12">
...
<!-- Text input-->
<div class="form-group">
  <label class="floatLabel" for="'.$i.'2"></label>  
  <div class="col-md-12">
...
<!-- Text input-->
<div class="form-group">
  <label class="floatLabel" for="'.$i.'3"></label>  
  <div class="col-md-12">
...
<!-- Text input-->
<div class="form-group">
  <label class="floatLabel" for="'.$i.'4"></label>  
  <div class="col-md-12">
